...
class ShopItemsView(ListView):
    ...
    queryset = ShopItem.on_site.prefetch_related('sections').all()
...
class SectionItemsView(ShopItemsView):
    ...
    def get_queryset(self):
        ...
        # queryset = Section.objects.prefetch_related('shop_items').get(slug=section_slug).shop_items.all()
        queryset = Section.on_site.prefetch_related('shop_items').get(slug=section_slug).shop_items.all()
        return queryset
